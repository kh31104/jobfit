...
export function renderMeasurePanel(ctx,timepoint='pre'){
  ...
  return `<div class="hr"></div><div class="block researchMeasurePanel" data-timepoint="${prefix}">
    ...
    <div class="summaryBox">
      <div class="sectionHead"><div><div class="kicker">PRIMARY OUTCOME · WORK24</div><h3>고용24 구직준비도검사</h3><p class="help">현재의 구직 준비상태를 여러 영역으로 확인하는 고용24 공식 검사입니다. 고용24에서 검사한 뒤 결과표에 표시된 9개 결과점수를 이 화면에 그대로 입력합니다.</p></div><span class="badge">대학생·성인 · 고용24 공식검사</span></div>
      ...
      <div class="callout warn"><b>고용24에서 ‘구직준비도검사’를 선택하세요.</b><br>검사명을 반드시 확인하세요. 직업선호도검사·대학생진로준비도검사와 다른 검사이며 PRE와 POST에서 동일한 ‘구직준비도검사’를 사용합니다.</div>
...
export function bindMeasurePanel(ctx,timepoint='pre'){
  ...
  saveBtn.addEventListener('click',()=>{
    ...
    const missing=[];if(!complete(w,9))missing.push('고용24 14개 T점수');if(!complete(k,KCAAS_SCALE.itemCount))missing.push('진로적응성 12문항');if(uInputs.length&&!complete(u,SUDCO_SCALE.itemCount))missing.push('강점활용·약점교정 9문항');
